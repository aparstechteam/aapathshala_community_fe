...
const nextConfig: NextConfig = {
  ...
  //     //   destination: 'https://capi.apars.tech/api/:path*',
  //     // },
  //     // {
  //     //   source: '/api/:path*',
  //     //   destination: 'https://capi.apars.tech/api/:path*',
  ...
  //     // {
  //     //   source: '/api/:path*',
  //     //   destination: 'https://communityapihono-development.up.railway.app/:path*',
  //     // },
  //     // {
  //     //   source: '/api/:path*',
  //     //   destination: 'https://communityapihono-production.up.railway.app/:path*',
  //     // },
