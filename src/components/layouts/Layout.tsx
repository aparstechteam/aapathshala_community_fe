...
const bg =
  "dark:bg-[#000000] bg-[#F5F6F7] dark:bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))]";
export const background = cn(
  bg,
  "w-full pb-10 min-h-screen text-white pt-[100px] px-2 lg:pt-[72px]"
);
...
export const Layout = (props: Props) => {
  ...
  const userinfo = (
    ...
    >
      <DialogContent
        className={cn(
          "bg-white dark:bg-black duration-300 text-black p-5",
    ...
    <div className="dark:!bg-[#171717] !bg-[#F5F6F7] dark:!text-white font-siliguri text-gray-700 relative">
      ...
      <div
        className={cn(
          ...
          router.pathname.includes("/onboard") && "hidden md:block"
        )}
      >
        <Header />
      </div>
      ...
      <div className="pt-[70px] flex w-full">
        ...
        <div
          className={cn(
            "bg-[#F5F6F7] dark:bg-[#171717] relative w-full min-h-[calc(100vh_-_70px)]"
          )}
        >
          <div
            className={cn(
              "fixed bg-[#F5F6F7] dark:bg-[#171717] h-screen w-full z-[1]"
            )}
          />
