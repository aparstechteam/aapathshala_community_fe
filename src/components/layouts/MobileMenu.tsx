...
export const MobileMenu = (props: Props) => {
  ...
  return (
    <Drawer direction="right">
      <DrawerTrigger className="flex items-center w-full justify-center text-hot dark:text-rose-500">
        <p
          className={cn(
        ...
        >
          <Avatar
            className={cn(
              "w-6 h-6",
              router.pathname === "/profile" && "ring-2 ring-hot"
            )}
          >
            <AvatarImage
              src={(user?.image as string) || "/user.jpg"}
              alt="Profile"
            />
            <AvatarFallback>
              {user?.name
        ...
        <div className="px-4 grid h-full">
          <div className="divide-gray-200 dark:divide-gray-800 h-full">
            <div className="space-y-2 px-2 py-1">
              ...
              <h4 className="font-semibold text-hot dark:text-hot">
                {user?.name}
              </h4>
            </div>
            <div className="grid gap-1 pt-3">
              <Link
                className="flex items-center gap-2 px-2 py-2 !border-0 hover:bg-gray-100 dark:hover:bg-gray-800/50 rounded-lg transition-colors text-gray-700 dark:text-gray-300 hover:text-hot dark:hover:text-hot"
                href="/profile"
              >
                <UserRound size={20} /> Dashboard
              </Link>
              <Link
                className="flex items-center gap-2 px-2 py-2 hover:bg-gray-100 dark:hover:bg-gray-800/50 rounded-lg transition-colors text-gray-700 dark:text-gray-300 hover:text-hot dark:hover:text-hot"
                href="/profile"
              >
              ...
              <DrawerClose className="w-full hidden justify-start">
                <ThemeToggle className="flex !shadow-none items-center text-start !justify-start gap-2 !px-2 !py-2 hover:bg-gray-100 dark:hover:bg-gray-800/50 rounded-lg transition-colors text-gray-700 dark:text-gray-300 hover:text-hot dark:hover:text-hot" />
              </DrawerClose>
            </div>
          </div>
        </div>
