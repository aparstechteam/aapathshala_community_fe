...
export const DashCard = ({
  ...
  <div
    className={cn(
      ...
      "bg-white dark:bg-rose-800/10",
      "ring-0 dark:ring-0 ring-slate-200 dark:ring-rose-700",
      "shadow-sm dark:shadow-md dark:shadow-rose-600/20",
  ...
  >
    ...
    <div className="mt-1">
      <h2 className="font-medium text-basemd:text-lg text-slate-800 dark:text-rose-400">
        {title}
      </h2>
      <h2 className="font-bold text-lg md:text-2xl text-slate-800 dark:text-rose-400">
        {stat}
      </h2>
    </div>
    {onClick && (
