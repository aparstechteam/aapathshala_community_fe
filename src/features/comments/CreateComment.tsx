import { Button, Dialog, DialogContent, DialogFooter, DialogHeader, DialogTitle, Input, useUser } from '@/components'
                ...
                <div className='p-1'>
                    <div className="relative w-[40px] h-[40px]">
                        <ValidImage
                            ...
                            width={40}
                            alt="Profile"
                            className="rounded-full w-[40px] h-[40px] object-cover cursor-pointer ring-1 bg-life/20 ring-life/70 hover:ring-life/50 transition-all duration-300"
                        />
                        <span className="absolute bottom-0 right-0 w-3 h-3 bg-life rounded-full border-2 border-gray-100"></span>
                    </div>
                </div>
