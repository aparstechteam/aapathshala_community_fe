...
import { Avatar, AvatarFallback, AvatarImage, Badge, ScrollArea, ScrollBar } from "@/components"
                        ...
                        >
                            <div className="flex items-center gap-4 w-full">
                                <Avatar className="!rounded-xl !p-0">
                                    ...
                                    <AvatarFallback className="!rounded-xl text-white bg-life/40">GRP</AvatarFallback>
                                </Avatar>
                                <div className="grid grid-cols-1 gap-2 w-full">
                                    ...
                                    <div className="flex col-span-1 items-center gap-2 justify-between">
                                        ...
                                        {g.is_member && (
                                            <Badge className="ml-auto !bg-olive/20 text-olive">
                                                {"Joined"}
                                            </Badge>
                                        )}
                                    </div>
