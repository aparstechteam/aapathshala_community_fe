...
export const TopSolvers: React.FC<Props> = (props) => {
  ...
  const { nextMonth, prevMonth, currentMonthIndex, currentMonth, data, loading } = props

  return (
    <>
      <div className="dark:!text-gray-100">

        <div className="flex items-center text-gray-800 dark:text-green-400 justify-between p-1 mb-3 dark:bg-gray-800 bg-gray-100 rounded-full">
          <Button size="sm" variant="ghost" disabled={currentMonthIndex === 0} onClick={prevMonth}>
            <ChevronLeft className="w-4 h-4" />
          </Button>
          <span className="text-sm pt-1 font-medium">
            {currentMonth}
          </span>
          <Button size="sm" variant="ghost" disabled={currentMonthIndex === months.length - 1} onClick={nextMonth}>
            ...
            {swap(data.first_3, 1, 0, 2)?.map((l, index) => {
              return data.first_3.length === 1 ? (
                  ...
                  <div key={l.id} className={
                    ...
                    <div className='grid justify-items-center'>
                      <div className='relative'>
                        <span className={cn('flex absolute -top-3 w-full justify-center')}>
                          <svg className='w-5 h-5' viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <defs>
                              <clipPath id="clip0_4_2711">
                                <rect width="11.1953" height="11.1953" fill="white"
                                  transform="translate(0.961914 0.918945)" />
                              </clipPath>
                            </defs>
                          </svg>
                        </span>
                        <ValidImage className='rounded-full w-[50px] h-[50px]' src={l?.image} alt={l?.name} width={50} height={50} />
                        <span className='absolute -bottom-1 -right-1'>

                          <svg className='w-5 h-5' viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <defs>
                              <clipPath id="clip0_4_2619">
                                <rect width="14.5569" height="14.5569" fill="white"
                      ...
                      <h4 className='text-sm capitalize pt-1 font-semibold'>{l?.name.split(' ')[0]}</h4>
                ...
                <div key={l.id} className={
                  ...
                  <div className='grid justify-items-center'>
                    <div className='relative'>
                      <span className={cn(index !== 1 && "hidden", index === 1 && "flex", 'absolute -top-3 w-full justify-center')}>
                        <svg className='w-5 h-5' viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <g clipPath="url(#clip0_4_2711)">
                            <path
                              d="M11.5819 3.04845C11.4114 2.97745 11.2237 2.95878 11.0426 2.99483C10.8615 3.03089 10.6952 3.12003 10.565 3.2509L9.35866 4.4572L7.21942 2.31795C7.04446 2.14305 6.80721 2.0448 6.55983 2.0448C6.31244 2.0448 6.07519 2.14305 5.90023 2.31795L3.76099 4.4572L2.55469 3.2509C2.42422 3.12046 2.258 3.03164 2.07706 2.99566C1.89611 2.95968 1.70856 2.97815 1.53811 3.04875C1.36766 3.11935 1.22197 3.23889 1.11945 3.39228C1.01694 3.54566 0.962198 3.726 0.962158 3.91049V8.84857C0.962899 9.46692 1.20887 10.0597 1.64611 10.497C2.08335 10.9342 2.67617 11.1802 3.29452 11.1809H9.82513C10.4435 11.1802 11.0363 10.9342 11.4735 10.497C11.9108 10.0597 12.1568 9.46692 12.1575 8.84857V3.91049C12.1575 3.72599 12.1029 3.54561 12.0004 3.39217C11.898 3.23873 11.7523 3.11911 11.5819 3.04845Z"
                      ...
                      <ValidImage className='rounded-full h-[50px] w-[50px]' src={l?.image} alt={l?.name} width={50} height={50} />
                      <span className='absolute -bottom-1 -right-1'>
                        {index === 1 && (
                          <svg className='w-5 h-5' viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clipPath="url(#clip0_4_2619)">
                        ...
                        {index === 0 && (
                          <svg className='w-5 h-5' viewBox="0 0 12 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                          ...
                          <svg className='w-5 h-5' viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <defs>
                              <clipPath id="clip0_4_2682">
                                <rect width="13.2336" height="13.2336" fill="white"
