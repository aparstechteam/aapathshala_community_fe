  ...
  return (
    <div className="p-4 mt-4 bg-white lg:rounded-xl ring-1 ring-ash dark:ring-ash/20 lg:shadow-md dark:bg-[#171717]">
        ...
        <div className='grid grid-cols-3 sm:h-[240px] h-[170px] py-5'>
          {swap(data?.first_3, 1, 0, 2)?.map((l, index) => {
            return data.first_3.length === 1 ? (
                  ...
                  <div className='grid justify-items-center'>
                    <div className='relative'>
                      ...
                      <span className='absolute -bottom-1 -right-1'>
                        ...
                        {index === 2 && (
                          <svg className='w-5 h-5 sm:w-8 sm:h-8' viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h4 className='text-sm mt-2 sm:text-lg capitalize font-semibold text-gray-800 dark:text-gray-100'>{l?.name.split(' ')[0]}</h4>
                    <h4 className='flex items-center gap-1 text-sm sm:text-base text-gray-800 dark:text-gray-100'>
                      <svg className='h-3 w-3 sm:h-4 sm:w-4' viewBox="0 0 9 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
              ...
              <div key={l?.id} className={cn('grid relative duration-300 hover:scale-95',
                index === 1 && "items-start",
                index !== 1 && "items-end"
              )}>
                <div className='grid justify-items-center'>
              ...
              <div key={l.id} className="flex items-center justify-between p-2 gap-2 transition-colors duration-200 hover:bg-green-500 hover:bg-opacity-10">
                <div className='flex items-center gap-3'>
                  ...
                  <div className="flex flex-col justify-start flex-1 min-w-0 line-clamp-2">
                    <h3 className="text-sm sm:text-base text-gray-600 dark:text-gray-400 text-start font-medium truncate cursor-pointer hover:text-green-500" onClick={() => Router.push(`/users/${l.id}`)}>
                      {l.name}
                    </h3>
                    <TooltipProvider>
                      <Tooltip>
                        ...
                        <TooltipContent className='bg-green-500 text-white'>{l.institute_name}</TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
                  </div>
                </div>
      ...
      {!limit ? (
        ...
        <div className={cn('pt-3 flex items-center justify-between', totalPages === 1 && '!hidden')}>
          <Button
            disabled={page === 1}
            variant='outline'
