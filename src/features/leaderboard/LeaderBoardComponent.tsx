    ...
    <div className="p-4 mt-4 bg-white lg:rounded-xl ring-1 ring-ash dark:ring-ash/20 lg:shadow-md dark:bg-[#171717]">
      <div className="grid py-2 gap-2 grid-cols-1 items-center justify-between">
        <div className="flex items-center justify-center">
          <h2 className="text-lg text-center py-2 font-semibold px-4 h-full text-black/80 dark:text-white rounded-lg ring-0 ring-ash dark:ring-ash/20">
            টপ কন্ট্রিবিউটরস্‌
          </h2>
        ...
        <div className="flex items-center !text-light  lg:ml-auto w-full justify-between px-2 h-full py-2 dark:bg-gray-800 bg-white ring-1 ring-ash dark:ring-ash/20 rounded-lg">
          <Button
            className="!rounded-full hover:text-hot !p-2"
            size="sm"
            variant="ghost"
          ...
          {swap(data?.first_3, 1, 0, 2)?.map((l, index) => {
            return data.first_3.length === 1 ? (
              <>
                ...
                <div key={l?.id} className={cn("grid items-start relative")}>
                  <div className="grid justify-items-center">
                    <div className="relative">
                      <span
                        className={cn(
                          index !== 0 && "hidden",
                          index === 0 && "flex",
                          "absolute -top-3 sm:-top-5 w-full justify-center"
                        )}
                      >
                        <svg
                    ...
                    <h4 className="text-sm mt-2 sm:text-lg capitalize font-semibold text-gray-800 dark:text-gray-100">
                      {l?.name.split(" ")[0]}
                    </h4>
                    <h4 className="flex items-center gap-1 text-sm sm:text-base text-gray-800 dark:text-gray-100">
                      <svg
                  ...
                  <Link
                    href={`/users/${l?.id}`}
                    className="absolute w-full h-full -top-2 -right-2"
                  ></Link>
                </div>
                <div></div>
              </>
              ...
              <div
                key={l?.id}
                className={cn(
                  "grid relative duration-300 hover:scale-95",
                  index === 1 && "items-start",
                  index !== 1 && "items-end"
                )}
              >
                <div className="grid justify-items-center">
                  <div className="relative">
                    ...
                    <ValidImage
                      className="rounded-full h-[60px] w-[60px] sm:hidden block"
                      src={l?.image}
                      alt={l?.name}
                      width={60}
                      height={60}
                    />
                    <ValidImage
                      className="rounded-full h-[100px] w-[100px] hidden sm:block"
                      src={l?.image}
                      alt={l?.name}
                      width={100}
                      height={100}
      ...
      {loading ? (
        <div className="text-center py-4 text-gray-500 w-full flex justify-center">
          <Loader2 className="animate-spin text-hot" />
        </div>
        ...
        <div className="divide-y dark:divide-gray-700 divide-gray-200">
          {data.leaderboard.length > 0 ? (
            data.leaderboard.map((l: LeaderboardEntry, index: number) => (
              <div
                key={l.id}
                className="flex items-center justify-between p-2 gap-2 transition-colors duration-200 hover:bg-rose-500 hover:bg-opacity-10"
              >
                <div className="flex items-center gap-3">
                  ...
                  <ValidImage
                    ...
                    width={60}
                    height={60}
                    className="w-8 h-8 bg-gray-200 text-gray-400 dark:bg-gray-700 sm:w-12 sm:h-12 cursor-pointer"
                  />
                  ...
                  {/* <Avatar className="w-8 h-8 bg-gray-200 text-gray-400 dark:bg-gray-700 sm:w-12 sm:h-12 cursor-pointer" onClick={() => Router.push(`/users/${l.id}`)}>
                    ...
                    <AvatarFallback>
                      {l.name ? l.name?.split(' ').map((n: string) => n[0]).join('') : 'U'}
                    </AvatarFallback>
                  </Avatar> */}
                  <div className="flex flex-col justify-start flex-1 min-w-0 line-clamp-2">
                    <h3
                      className="text-sm sm:text-base text-gray-600 dark:text-gray-400 text-start font-medium truncate cursor-pointer hover:text-rose-500"
      ...
      {!limit ? (
        <div className="mt-2 text-sm text-rose-500 text-center">
        ...
        >
          <Button
            disabled={page === 1}
            variant="outline"
            className="text-hot dark:text-hot bg-white dark:bg-[#171717] border-hot dark:border-hot hover:bg-rose-500/10 dark:hover:bg-rose-500/20 !px-4 !rounded-full hover:text-rose-700 dark:hover:text-rose-300 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            onClick={() => setPage(page - 1)}
            type="button"
          >
            <span className="pt-1">Prev Page</span>
          </Button>
          ...
          <Button
            ...
            type="button"
          >
            <span className="pt-1">Next Page</span>
          </Button>
        </div>
      )}
    </div>
