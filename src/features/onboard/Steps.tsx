...
export const Steps = (props: Props) => {
  ...
  return (
    <div className="grid items-start justify-center min-h-[500px] p-4">
      ...
      <div
        className={cn(
          "grid items-center justify-center sm:justify-between gap-5 py-4",
          col === 1 ? `grid-cols-1` : `grid-cols-1 sm:grid-cols-2`
        )}
      >
        {datas.map((item, index) => (
          <button
            ...
            className={cn(
              ...
              error && !data
                ? "ring-red-500 shadow-red-500 shadow-none"
                : data === item.id
                ? "ring-hot shadow-hot shadow-none"
                : "ring-ash shadow-ash shadow-none"
            )}
          >
            {!!icon || (
              <>
