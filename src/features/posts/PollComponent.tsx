              ...
              {polls?.map((option, index) => (
                <div key={index}>
                  <div className="flex items-center gap-1 w-full mb-2">
                    ...
                    <button
                      className="w-full flex items-center hover:!text-hot justify-between"
                      type="button"
                      onClick={(e) => {
                        e.preventDefault();
                        e.stopPropagation();
                  ...
                  <div className="flex rounded-full relative items-center bg-ash/50 gap-2 group">
                    <div
                      className={cn(
                        "absolute z-[1] duration-300 overflow-hidden inset-0 rounded-full",
                    ...
                    >
                      <div
                        className={cn(
                          "rounded-full relative z-[2] h-full w-full duration-700 transition-all",
                          option.has_voted &&
                            option.vote_count > 0 &&
                            "bg-gradient-to-r from-hot to-hot animate-progress",
                          !option.has_voted &&
                            option.vote_count > 0 &&
                            "bg-light animate-progress"
                        )}
                      />
                    </div>
                    ...
                    <div
                      className={cn(
                        "flex-1 z-10 flex items-center justify-between duration-300 rounded-full h-1"
                        // selectedAnswer === option.name && "bg-hot/20 text-hot",
          ...
          <div className="px-4 md:px-0 !w-full grid gap-2">
            ...
            >
              {polls?.map((option, index) => (
                <div
                  key={index}
                  className="grid relative items-center gap-2 group"
                >
