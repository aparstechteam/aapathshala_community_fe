...
export const PrevQuiz = (props: Props) => {
  ...
  return !loading && quizResult?.results && quizResult?.results.length > 0 ? (
    <div className="bg-white rounded-lg dark:bg-rose-900/30 p-4 mt-4 ring-1 dark:divide-ash/20 dark:ring-0 ring-ash">
      <h2 className="text-center text-lg font-semibold">
        পূর্ববর্তী কুইজের ফলাফল
      </h2>
            ...
            <div>
              ...
              <p className="flex items-center justify-between">
                <span className="text-sm">
                  <strong>সময়:</strong> {x.duration} মিনিট
                </span>
                <span className="text-sm">
                  <strong>স্কোর:</strong> {x.score}
                </span>
              </p>
            </div>
          </div>
