      ...
      <CardContent className="px-0 py-4 !ring-0">
        <ScrollArea className="h-[380px]">
          <div className="space-y-2 px-4">
            <div
              className={`w-full flex  relative items-center justify-between hover:bg-rose-50 dark:hover:bg-gray-700/30 p-2 rounded-lg text-sm
                          ${
                            selectedSubject === "all"
            ...
            >
              <div className="flex items-center gap-3">
                <div className={`${subjects[0]?.color}`}>
                  {subjects[0]?.icon}
                </div>
            ...
            {allSubjects?.map((subject, index) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <div className={`${subjects[index + 1]?.color}`}>
                    {subjects[index + 1]?.icon}
                  </div>
