        ...
        <>
            ...
            <div className='grid items-center justify-center h-screen bg-[#E4E9F5]'>
                <div className='flex py-2 flex-col items-center justify-center gap-2'>
                    ...
                    <Link href='/' className='bg-primary lg:text-xl text-lg text-black hover:text-black/80 hover:scale-90 text-semibold transition-all duration-300 shadow-lg shadow-life/50 bg-life px-4 py-2 text-center rounded-md'>
                        হোম এ ফিরে যাও
                    </Link>
                </div>
            </div>
