...
import { lifeGoals, personalityTypes } from "@/data/subjects";
...
const OnboardPage = () => {
  ...
  const [media, setMedia] = useState<number>(1);
  ...
  const [personality, setPersonality] = useState<number>(2);
  ...
  const errors = [
    "সোর্স সিলেকট করুন",
    "জেলা, থানা এবং স্কুল সিলেকট করুন",
    "সাবজেক্ট সিলেকট করুন",
    "পছন্দের সাবজেক্ট সিলেকট করুন",
    "আপনার শখ সিলেকট করুন",
    "পছন্দের কন্টেন্ট সিলেকট করুন",
    "পছন্দের কন্টেন্ট ক্রিয়েটর সিলেকট করুন",
    "লক্ষ্য সিলেক্ট করুন",
    "পারসনালিটি টাইপ সিলেক্ট করুন",
  ];
  ...
  async function handleSubmit() {
    try {
      ...
      toast({
        title: "অভিনন্দন",
        description: "আপনার অনবোর্ডিং সম্পন্ন হয়েছে।",
        variant: "success",
      });
      ...
      toast({
        title: "দুঃখিত",
        description: "কিছু ত্রুটি দেখাচ্ছে। আবার চেষ্টা করুন।",
        variant: "destructive",
      });
    }
  }
    ...
    try {
      ...
      setSchools([
        ...schools,
        {
          ...
          school_name: res.data.data.name as string,
        },
      ]);
  ...
  async function handleInfoSubmit(e: React.MouseEvent<HTMLButtonElement>) {
    ...
    if (!myinfo.gender) {
      toast({
        title: "দুঃখিত",
        description: "ছেলে না মেয়ে সিলেক্ট করুন",
        variant: "destructive",
      });
      setError("d");
      return;
    ...
    // if (!myinfo.bio) {
    //     setError('আপনি নিজের সম্পর্কে লিখুন')
    //     return
    // }
    // if (!preview) {
    //     setError('আপনি প্রোফাইল পিকচার যুক্ত করুন')
    //     return
    // }
    try {
      setIsLoading(true);
      const res = await axios.put(`${secondaryAPI}/api/auth/update`, myinfo, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("accessToken")}`,
        },
      });
      ...
      toast({
        title: "অভিনন্দন",
        description: "আপনার প্রোফাইল সম্পন্ন হয়েছে।",
        variant: "success",
      });
  ...
  const titles = [
    "অলমোস্ট শেষ! আপনার কিছু তথ্য দাও",
    "কমিউনিটি এর ব্যবহারবিধি",
    "আপনার সহপাঠীদের ফলো করুন",
  ];
      ...
      >
        ...
        {infoStep === 0 && (
          <div className="grid gap-4 p-4">
            {/* <h2 className='text-2xl font-semibold'>আপনার প্রোফাইল দেখো</h2> */}
            ...
            <div className="w-full  ">
              ...
              <Input
                required
                className={cn(
                  "w-full !px-4 !pb-1 focus:!ring-2 !rounded-lg !border-0 !ring-2 ring-ash shadow-none duration-300 dark:bg-hot/10 bg-white dark:text-white text-gray-900 hover:bg-ash/20 dark:hover:bg-ash/20",
            ...
            <div className="w-full  ">
              <Label>নিজের সম্পর্কে লিখুন</Label>
              <Input
            ...
            <div className="w-full grid grid-cols-2 gap-x-4 gap-y-2">
              <Label className="col-span-2">আপনি একজন</Label>
              <button
                onClick={() => {
                  setError("");
            ...
            <div className="w-full">
              <div className="flex flex-col gap-3">
                ...
                >
                  ...
                  >
                    <SelectValue placeholder={"আপনি কোন ধর্মের অনুসারী?"} />
                  </SelectTrigger>
                  <SelectContent
                    align="start"
                ...
                {error && !myinfo.religion && (
                  <p className="text-hot text-xs">ধর্ম সিলেক্ট করুন</p>
                )}
              </div>
            </div>
            <div className="w-full">
              <div className="flex flex-col gap-3">
                <Label>আপনার ব্যাচ সিলেক্ট করুন</Label>
                <Select
                ...
                >
                  ...
                  >
                    <SelectValue placeholder={"আপনি কোন ব্যাচে পড়ো?"} />
                  </SelectTrigger>
                  <SelectContent
                    align="start"
                    className="dark:!bg-gray-800 text-light dark:text-gray-200 !bg-white max-h-[250px]"
                ...
                {error && !myinfo.hsc_batch && (
                  <p className="text-hot text-xs">ব্যাচ সিলেক্ট করুন</p>
                )}
              </div>
            </div>
          </div>
        ...
        {infoStep === 2 && (
          <ScrollArea className="overflow-y-auto h-[400px]">
            {/* <h2 className="font-medium py-2 w-full">আপনার সহপাঠীদের ফলো করুন</h2> */}
                ...
                >
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      x.isFollowing ? "bg-hot text-white" : "bg-hot/20 text-hot"
                    )}
                  >
            ...
            {/* <h2 className="font-medium py-2 w-full">আপনার শিক্ষকদের ফলো করুন</h2>
            ...
            {/* <h2 className="font-medium py-2 w-full">
                            ক্লাব এক্সিকিউটিভ মেম্বারদের ফলো করুন
                        </h2>
                        <div className="flex flex-wrap items-center pb-4 justify-center gap-2">
                            {authorities?.map((x, i) => (
                                <div
        ...
        <DialogFooter>
          <div className="flex items-center justify-end gap-4 w-full">
            {infoStep > 0 && (
              ...
              >
                {infoStep === 0 ? "স্কিপ করুন" : "ফিরে যাও"}
              </Button>
            )}
            <Button
              type="button"
          ...
          <div className="flex flex-col gap-4 items-center justify-center w-full max-w-screen-xl">
                ...
                >
                  <div
                    className={cn(
                      ...
                      currentStep > 0 && "bg-gradient-to-r from-hot to-hot",
                ...
                <div className="grid items-center justify-center lg:p-0 p-4 gap-3 lg:relative text-black dark:text-white">
                  ...
                  <div className="lg:!absolute bottom-[100px] right-[-328px] lg:!w-[328px] w-full bg-zemer p-4 rounded-lg">
                    ...
                    <h2 className="text-base font-medium">
                      কমিউনিটিতে আপনাকে স্বাগতম। 🚀
                    </h2>
                    <h2 className=" text-light font-medium">
                      আপনার পার্সোনালইজড হোমপেইজের জন্য তোমাকে কিছু প্রশ্নের
                      উত্তর দিতে হবে, যেন আপনার ইন্টারেস্টের উপর ভিত্তি করে
              ...
              <div className="grid items-start justify-center min-h-[500px] p-4">
                <div className="flex gap-4 items-center justify-center relative text-black dark:text-white">
                  ...
                  <div className="sm:w-[328px] bg-zemer p-4 rounded-lg">
                    <h2>আপনার এলাকা এবং কলেজ সিলেক্ট করুন</h2>
                  </div>
                </div>
                <div
                  className={cn("space-y-5", addSchool && "pb-[150px] sm:pb-0")}
                >
                  <div className="flex flex-col gap-3">
                    <Label>জেলা</Label>
                    <Select
                    ...
                    >
                      <SelectTrigger
                        className={cn(
                          "w-full !px-4 !pb-1 !rounded-lg ring-2 ring-ash shadow-none duration-300 dark:bg-ash/10 bg-white dark:text-white text-gray-900 hover:bg-ash/20 dark:hover:bg-rose-200/20",
                    ...
                    {error && !city && (
                      <p className="text-hot text-xs">জেলা সিলেক্ট করুন</p>
                    )}
                  </div>
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    {error && !area && (
                      <p className="text-hot text-xs">থানা সিলেক্ট করুন</p>
                    )}
                  </div>
                  {addSchool ? (
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="flex gap-2 items-center justify-center">
                        <Input
                          className="w-full !h-10 !rounded-lg !text-black !ring-2 !duration-300 transition-all focus:ring-hot/50 !shadow-none !bg-white !border-none !outline-none"
                          value={schoolName}
                        ...
                        <Button
                          ...
                          size="sm"
                          className="w-10 rounded-full !h-10 !ring-0 !shadow-none !bg-hot/20 !border-none !outline-none"
                        >
                          {sLoading ? (
                            <Loader2 className="animate-spin text-center mb-1" />
                          ) : (
                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      {error && !school && (
                        <p className="text-hot text-xs">কলেজ সিলেক্ট করুন</p>
                      )}
                    </div>
                  )}
                </div>
            ...
            {currentStep === 2 && (
              <Steps
                ...
                ques="ভর্তি পরীক্ষায় আপনার লক্ষ্য কী?"
              />
            )}
            ...
            <div className="pb-10">
              <Button
                ...
                className={cn(
                  ...
                  disabledNext ? "bg-light/50" : "bg-hot shadow-hot"
                )}
              >
                {currentStep === 2 ? (
                  <>
